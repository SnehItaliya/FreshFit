    ...
    <form onSubmit={onsubmitHandler} className='flex flex-col w-full items-start gap-3'>
        <div>
            ...
            <div className='w-full'>
                ...
                <textarea onChange={(e)=>setDescription(e.currentTarget.value)} value={description} className='w-full max-w-[500px] px-3 py-2' type="text" placeholder='Write conntent here' required/>
            </div>
